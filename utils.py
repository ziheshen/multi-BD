...
def train_parse_args(input_args=None):
    ...
    parser.add_argument("--img_adapter_lr_scale", type=float, default=10.0)
    parser.add_argument("--proj_lr_scale", type=float, default=10.0)
    parser.add_argument("--text_encoder_lr_scale", type=float, default=0.1)
